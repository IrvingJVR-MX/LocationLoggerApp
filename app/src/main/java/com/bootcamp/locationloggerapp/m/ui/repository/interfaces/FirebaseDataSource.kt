...
interface FirebaseDataSource {
    ...
    suspend fun <T : Any> addDocumentWithId(document: T, collection: FirebaseCollections, id: String): Response<String>
    ...
    suspend fun getPostCollectionWithId(collection: FirebaseCollections, id:String): Response<MutableList<Post>>
    suspend fun getUserInfo(collection: FirebaseCollections, id:String):Response<MutableList<User>>
    suspend fun deleteCollectionWithId(collection: FirebaseCollections, id: String): Response<Boolean>
    suspend fun updateCollectionWithId(collection: FirebaseCollections, id: String, name: String, profilePhotoUrl: String, profilePhotoPath: String, backgroundPhotoUrl:String, backgroundPhotoPath: String): Response<Boolean>
