...
class EditProfileFragment : Fragment() {
    ...
    private fun initButton(){
        binding.btnSave.setOnClickListener{
           ...
           viewModel.deletePhotos(userId,name, profilePhotoUrl, profilePhotoPath,backgroundPhotoPath,backgroundPhotoUrl,selectedPhotoProfile, selectedCoverPhoto)
        }
    ...
    private fun args (){
        ...
        val userIdArgs = args?.get("userId")
        val userNameArgs = args?.get("userName")
        val profilePhotoUrlArgs = args?.get("profilePhotoUrl")
        val profilePhotoPathArgs = args?.get("profilePhotoPath")
        val backgroundPhotoUrlArgs = args?.get("backgroundPhotoUrl")
        val backgroundPhotoPathArgs = args?.get("backgroundPhotoPath")
